...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 32772)) {
          update_slot_base(
            default_slot,
...
var get_default_slot_context3 = (ctx) => ({
  route: ctx[1] && ctx[1].uri,
  location: ctx[0]
});
function create_fragment3(ctx) {
  let current;
  const default_slot_template = ctx[12].default;
  const default_slot = create_slot(default_slot_template, ctx, ctx[11], get_default_slot_context3);
  const block = {
    c: function create() {
      if (default_slot)
        default_slot.c();
      ...
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 2051)) {
          update_slot_base(
            ...
            ctx2,
            ctx2[11],
            !current ? get_all_dirty_from_scope(ctx2[11]) : get_slot_changes(default_slot_template, ctx2[11], dirty, get_default_slot_changes3),
