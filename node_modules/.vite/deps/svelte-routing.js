...
var get_default_slot_changes = (dirty) => ({ active: dirty & 4 });
var get_default_slot_context = (ctx) => ({ active: !!ctx[2] });
function create_fragment(ctx) {
  ...
  const default_slot = create_slot(default_slot_template, ctx, ctx[16], get_default_slot_context);
  let a_levels = [
    { href: ctx[0] },
    { "aria-current": ctx[2] },
    ctx[1],
  ...
  const block = {
    ...
    m: function mount(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = listen_dev(a, "click", ctx[5], false, false, false, false);
        mounted = true;
      }
    },
    p: function update(ctx2, [dirty]) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 65540)) {
          update_slot_base(
            default_slot,
            default_slot_template,
            ctx2,
            ctx2[16],
            !current ? get_all_dirty_from_scope(ctx2[16]) : get_slot_changes(default_slot_template, ctx2[16], dirty, get_default_slot_changes),
...
var get_default_slot_changes2 = (dirty) => ({ params: dirty & 4 });
var get_default_slot_context2 = (ctx) => ({ params: ctx[2] });
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 132)) {
          update_slot_base(
            default_slot,
            default_slot_template,
            ctx2,
            ctx2[7],
            !current ? get_all_dirty_from_scope(ctx2[7]) : get_slot_changes(default_slot_template, ctx2[7], dirty, get_default_slot_changes2),
...
function create_then_block(ctx) {
  ...
  let current;
  const switch_instance_spread_levels = [ctx[2], ctx[3]];
  var switch_value = ((_a = ctx[12]) == null ? void 0 : _a.default) || ctx[12];
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & 1 && switch_value !== (switch_value = ((_a2 = ctx2[12]) == null ? void 0 : _a2.default) || ctx2[12])) {
        if (switch_instance) {
          group_outros();
...
function create_fragment2(ctx) {
  let if_block_anchor;
  let current;
  let if_block = ctx[1] && ctx[1].route === ctx[5] && create_if_block(ctx);
  const block = {
    c: function create() {
      if (if_block)
        if_block.c();
...
function create_else_block2(ctx) {
  ...
  const default_slot = create_slot(default_slot_template, ctx, ctx[14], get_default_slot_context_1);
  const block = {
    c: function create() {
      if (default_slot)
        default_slot.c();
    ...
    p: function update(ctx2, dirty) {
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 16390)) {
          update_slot_base(
            default_slot,
            default_slot_template,
            ctx2,
            ctx2[14],
            !current ? get_all_dirty_from_scope(ctx2[14]) : get_slot_changes(default_slot_template, ctx2[14], dirty, get_default_slot_changes_1),
...
function create_if_block2(ctx) {
  let previous_key = ctx[1].pathname;
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      if (dirty & 2 && safe_not_equal(previous_key, previous_key = ctx2[1].pathname)) {
        group_outros();
...
function create_key_block(ctx) {
  ...
  let current;
  const default_slot_template = ctx[15].default;
  const default_slot = create_slot(default_slot_template, ctx, ctx[14], get_default_slot_context3);
  const block = {
    c: function create() {
      div = element("div");
      if (default_slot)
      ...
      if (default_slot) {
        if (default_slot.p && (!current || dirty & 16390)) {
          update_slot_base(
            ...
            ctx2,
            ctx2[14],
            !current ? get_all_dirty_from_scope(ctx2[14]) : get_slot_changes(default_slot_template, ctx2[14], dirty, get_default_slot_changes3),
    ...
    i: function intro(local) {
      ...
      add_render_callback(() => {
        ...
        if (div_outro)
          div_outro.end(1);
        div_intro = create_in_transition(div, ctx[3], {});
        div_intro.start();
      });
      current = true;
    },
    o: function outro(local) {
      ...
      div_outro = create_out_transition(div, ctx[3], {});
      current = false;
    },
    d: function destroy(detaching) {
      if (detaching)
