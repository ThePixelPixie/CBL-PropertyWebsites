<script>
  ...
  let currentImageUrl = "/images/chatt-symphony.jpeg"; // square
...
<section class="enjoy w-full max-w-screen-2xl mx-auto flex flex-col lg:flex-row items-start p-2 md:p-12 !overflow-x-visible">
  <div id="DealInfo" class="w-full lg:w-2/3 mx-auto px-4 sm:px-9 md:pl-0 md:pr-12 mt-10">
    ...
    <!-- change to btn-xxx-solid for button color change -->
    <a href="#" class="btn-enjoy-solid my-3 max-w-md" title="Deal CTA" aria-label="Deal CTA" target="_blank">Deal CTA</a>
