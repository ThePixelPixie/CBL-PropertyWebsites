<svg class="footer-wave-svg relative block fill-transparent h-8 w-screen top-0 z-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 100" preserveAspectRatio="none">
