<script>
  ...
  const borderColors = [
    'border-news hover:border-news-d',
    'border-eat hover:border-eat-d',
    'border-burgundy hover:border-burgundy-d',
    'border-shop hover:border-shop-d',
    'border-green hover:border-green-d'
  ]
</script>
